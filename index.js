...
const priceactionlist = ["price-BTC",'price-TRX','price-ETH', 'price-NANO',"price-ETC",'price-ADA','price-XMR', 'price-BCH'];
...
bot.action(priceactionlist, async ctx => {
    ...
    //    console.log(symbol);
    try {
      const res = await axios.get(`https://min-api.cryptocompare.com/data/price?fsym=${symbol}&tsyms=USD,NGN,EUR&api_key=${apikey}`);
